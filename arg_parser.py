...
class ArgParser(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--step_train_discriminator', type=int, default=5, help='Train discriminator x steps for every 1 step of generator.')
    ...
    def parse_args(self):
        ...
        if len(args.gpu_ids) > 0 and torch.cuda.is_available() and args.gpu_ids[0] >= 0:
